...
| Metric | Claw Compactor | LLMLingua-2 | Delta |
|--------|---------------|-------------|-------|
| **ROUGE-L** | **0.653** | 0.346 | **+88.2%** |
| Token reduction | 70% | 70% | — |
| LLM cost | $0 | ~$0.02/call | — |
| Latency | <50ms | ~300ms | **6x faster** |
...
| Scenario | Input Tokens | After Compression | Savings | Time |
|----------|-------------|-------------------|---------|------|
...
- [Full benchmark data](../benchmark/results/benchmark_results.json)
- [Benchmark runner source](../benchmark/run_benchmark.py)
